...
<div>
    <div class="form-group">
        <label for="links_chart_cache"><?= l('admin_settings.links.links_chart_cache') ?></label>
        <div class="input-group">
            <input id="links_chart_cache" type="number" min="0" max="24" name="links_chart_cache" class="form-control" value="<?= settings()->links->links_chart_cache ?? 12 ?>" />
