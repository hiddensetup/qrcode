...
class AdminApiDomains extends Controller {
    ...
    private function post() {
        ...
        /* Clear the cache */
        cache()->deleteItems(['domains?user_id=' . $this->api_user->user_id, 'domains_total?user_id=' . $this->api_user->user_id]);
        cache()->deleteItemsByTag('domains?user_id=' . $this->api_user->user_id);
    ...
    private function patch() {
        ...
        /* Clear the cache */
        cache()->deleteItem('domains?user_id=' . $domain->user_id);
        cache()->deleteItemsByTag('domain_id=' . $domain->domain_id);
        cache()->deleteItem('available_additional_domains');
