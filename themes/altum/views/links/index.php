    ...
    <?php if(count($data->links)): ?>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <?php if(settings()->links->links_chart_cache ?? 12): ?>
                    <small class="text-muted"><i class="fas fa-fw fa-info-circle mr-1"></i> <?= sprintf(l('links.chart_help'), settings()->links->links_chart_cache ?? 12) ?></small>
                <?php endif ?>
            </div>
        </div>
                            ...
                            <td class="text-nowrap">
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="small">
                                        ...
                                        <a href="<?= $row->location_url ?>" title="<?= remove_url_protocol_from_url($row->location_url) ?>" class="text-muted align-middle" target="_blank" rel="noreferrer"><?= string_truncate(remove_url_protocol_from_url($row->location_url), 32) ?></a>
                                    </div>
                                </div>
                            </td>
