...
class Link extends Controller {
    ...
    public function process_redirect() {
        ...
        if($this->user->plan_settings->utm_parameters_is_enabled) {
            $utm_parameters = [];
            if($this->link->settings->utm->source) $utm_parameters['source'] = $this->link->settings->utm->source;
            if($this->link->settings->utm->medium) $utm_parameters['medium'] = $this->link->settings->utm->medium;
            if($this->link->settings->utm->campaign) $utm_parameters['campaign'] = $this->link->settings->utm->campaign;
