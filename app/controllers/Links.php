...
class Links extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['is_enabled', 'project_id', 'domain_id', 'links_ids'], ['url', 'location_url'], ['last_datetime', 'datetime', 'url', 'location_url', 'pageviews'], [], ['links_ids' => 'json_contains']));
        ...
        if(count($links) && !$filters->has_applied_filters) {
            ...
            $links_chart = \Altum\Cache::cache_function_result('statistics?user_id=' . $this->user->user_id, null, function() use ($statistics_result_query) {
                ...
                return $links_chart;
            }, 60 * 60 * settings()->links->links_chart_cache ?? 12);
