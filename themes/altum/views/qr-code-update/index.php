                    ...
                    <div class="card-body">
                        ...
                        <div class="collapse" id="colors_container" data-parent="#form">
                            ...
                            <div class="form-group" data-range-counter data-range-counter-suffix="%">
                                ...
                                <input id="background_color_transparency" type="range" min="0" max="95" step="5" name="background_color_transparency" value="<?= $data->qr_code->settings->background_color_transparency ?? 0 ?>" class="form-control-range <?= \Altum\Alerts::has_field_errors('background_color_transparency') ? 'is-invalid' : null ?>" data-reload-qr-code />
