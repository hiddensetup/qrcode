    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-2">
                    <span data-toggle="tooltip" title="<?= l('link_statistics.statistics.country_help') ?>">
                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            ...
                            <?php if($row->country_code): ?>
                                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=city_name&country_code=' . $row->country_code . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $row->country_code ?>" class="align-middle"><?= get_country_from_country_code($row->country_code) ?></a>
                            <?php else: ?>
