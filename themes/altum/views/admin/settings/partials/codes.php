...
<div>
    <div class="form-group custom-control custom-switch">
        ...
        <label class="custom-control-label" for="qr_codes_is_enabled"><?= l('admin_settings.codes.qr_codes_is_enabled') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        <label class="custom-control-label" for="qr_reader_is_enabled"><?= l('admin_settings.codes.qr_reader_is_enabled') ?></label>
    </div>
    ...
    <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= get_max_upload() ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), get_max_upload()) ?>">
        <label for="qr_codes_branding_logo"><i class="fas fa-fw fa-sm fa-qrcode text-muted mr-1"></i> <?= l('admin_settings.codes.qr_codes_branding_logo') ?></label>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        <label class="custom-control-label" for="barcodes_is_enabled"><?= l('admin_settings.codes.barcodes_is_enabled') ?></label>
    </div>
    ...
    <div class="form-group custom-control custom-switch">
        ...
        <label class="custom-control-label" for="barcode_reader_is_enabled"><?= l('admin_settings.codes.barcode_reader_is_enabled') ?></label>
    </div>
